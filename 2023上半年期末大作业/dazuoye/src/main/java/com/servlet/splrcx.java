...
/**
 * Servlet implementation class splrcx
 */
@WebServlet("/splrcx")
public class splrcx extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String	sq="select commodity.*,profit.* from commodity,profit where commodity.number=profit.number";
		...
		request.getRequestDispatcher("splr.jsp").forward(request, response);
	}
